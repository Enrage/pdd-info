...
<section>
	...
	<form action="" method="post" accept-charset="utf-8" enctype="multipart/form-data">
		...
		<input type="text" name="name_menu" id="title_news" value="<?=$res[0]?>"></p>
		<p>Текст меню:<br>
		...
		<input type="text" name="meta_key" id="keywords_news" value="<?=$res[2]?>"></p>
		<p>Meta описание:<br>
		<input type="text" name="meta_desc" id="description_news" value="<?=$res[3]?>"></p>
