...
<table class="news_title">
	...
	<tr>
		<td><a href="?option=update_menu&amp;id_menu=<?=$row[0]?>"><?=$row[1]?></a></td>
		<td class="del_news"><a href="?option=delete_menu&amp;id_menu=<?=$row[0]?>">Del&nbsp;<img src="img/del.png" width="12" alt="delete"></a></td>
	</tr>
	<?php endforeach; ?>
</table>