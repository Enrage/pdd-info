...
<table class="news_title">
	...
	<tr>
		<td><a href="?option=update_auto_news&amp;id_news=<?=$row['id_news']?>"><?=$row['title']?></a></td>
		<td class="td_date"><?=$row['date']?></td>
		<td class="del_news"><a href="?option=delete_auto_news&amp;id_news=<?=$row['id_news']?>">Del&nbsp;<img src="img/del.png" width="12" alt="delete"></a></td>
	</tr>
	<?php endforeach; ?>
</table>